...
---
# <a name="iteration-1--create-the-application-c"></a>반복 #1 – 애플리케이션 만들기(C#)
...
**그림 01**: 새 프로젝트 대화 상자[(클릭하여 전체 크기 이미지 보기)](iteration-1-create-the-application-cs/_static/image2.png)
...
**그림 07**: 모델 내용 선택[(전체 크기 이미지를 보려면 클릭)](iteration-1-create-the-application-cs/_static/image14.png)
...
**그림 08**: 데이터 연결을 선택[(전체 크기 이미지를 보려면 클릭)](iteration-1-create-the-application-cs/_static/image16.png)
...
**그림 09**: 데이터베이스 객체 선택[(전체 크기 이미지를 보려면 클릭)](iteration-1-create-the-application-cs/_static/image18.png)
...
**그림 10**: 연락처 클래스[(전체 크기 이미지를 보려면 클릭)](iteration-1-create-the-application-cs/_static/image20.png)
...
**그림 12**: 색인 보기 추가[(전체 크기 이미지를 보려면 클릭)](iteration-1-create-the-application-cs/_static/image24.png)

뷰 **추가** 대화 상자에서 **강력한 형식의 뷰 만들기라는 레이블이**붙은 확인란을 선택합니다. 데이터 클래스 연락처 관리자.Models.Contact 및 보기 콘텐츠 목록을 선택합니다. 이러한 옵션을 선택하면 연락처 레코드 목록을 표시하는 뷰가 생성됩니다.
...
**그림 13**: 추가 보기 대화 상자[(전체 크기 이미지를 보려면 클릭)](iteration-1-create-the-application-cs/_static/image26.png)
...
**그림 14**: 디버깅 활성화[(전체 크기 이미지를 보려면 클릭)](iteration-1-create-the-application-cs/_static/image28.png)
...
**그림 15**: 색인 보기[(전체 크기 이미지를 보려면 클릭)](iteration-1-create-the-application-cs/_static/image30.png)
...
**목록 4 - 컨트롤러\HomeController.cs (메서드 만들기 사용)**
...
**그림 16**: 만들기 보기 추가[(전체 크기 이미지를 보려면 클릭)](iteration-1-create-the-application-cs/_static/image32.png)

뷰 **추가** 대화 상자에서 **ContactManager.Models.Contact** 클래스 및 보기 내용에 대한 **만들기** 옵션을 선택합니다(그림 17 참조). **추가** 단추를 클릭하면 뷰 만들기가 자동으로 생성됩니다.
...
**그림 17**: 페이지 폭발 보기[(전체 크기 이미지를 보려면 클릭)](iteration-1-create-the-application-cs/_static/image34.png)
...
**그림 18**: 뷰 만들기[(전체 크기 이미지를 보려면 클릭)](iteration-1-create-the-application-cs/_static/image36.png)
...
**목록 6 - 컨트롤러\HomeController.cs (편집 방법 사용)**
...
**목록 8 - 컨트롤러\HomeController.cs (방법 삭제)**
...
**그림 21**: 편집 링크가 있는 색인[보기(전체 크기 이미지를 보려면 클릭)](iteration-1-create-the-application-cs/_static/image42.png)
...
이 문제는 쉽게 해결할 수 있습니다. 먼저 홈 컨트롤러의 이름을 리팩터링해야 합니다. 비주얼 스튜디오 코드 편집기에서 HomeController 클래스를 열고 클래스 이름을 마우스 오른쪽 버튼으로 클릭하고 메뉴 옵션 **리팩터링, 이름 바꾸기를**선택합니다. 이 메뉴 옵션을 선택하면 이름 바꾸기 대화 상자가 열립니다.
...
**그림 25**: 기본 컨트롤러 없음[(전체 크기 이미지를 보려면 클릭하십시오)](iteration-1-create-the-application-cs/_static/image50.png)

홈 컨트롤러 대신 연락처 컨트롤러를 사용하려면 Global.asax 파일의 기본 경로를 업데이트해야 합니다. Global.asax 파일을 열고 기본 경로에서 사용하는 기본 컨트롤러를 수정합니다(목록 10 참조).

**목록 10 - Global.asax.cs**
