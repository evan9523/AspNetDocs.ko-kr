...
title: '반복 #4 – 응용 프로그램을 느슨하게 결합(VB) | 마이크로 소프트 문서'
...
ms.locfileid: "81542770"
---
# <a name="iteration-4--make-the-application-loosely-coupled-vb"></a>반복 #4 – 애플리케이션을 느슨하게 결합(VB)
...
**목록 1 - 모델\IContactManagerRepository.vb**
...
**목록 2 - 모델\엔터티연락처관리자Repository.vb**
...
**목록 5 - 모델\IContactManagerService.vb**
...
**목록 7 - 모델\유효성 검사\모델스테이트래퍼.vb**

[!code-vb[Main](iteration-4-make-the-application-loosely-coupled-vb/samples/sample7.vb)]

**목록 8 \ 모델\유효성 검사\IvalidationDictionary.vb**
